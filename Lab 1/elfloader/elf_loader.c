...
void initTableImport(void** tableImport) {
    tableImport[0] = png_create_write_struct;
    tableImport[1] = png_create_info_struct;
    tableImport[2] = png_init_io;
    tableImport[3] = png_free_data;
    tableImport[4] = png_destroy_write_struct;
    tableImport[5] = png_write_row;
    tableImport[6] = png_write_end;
    tableImport[7] = png_set_IHDR;
    tableImport[8] = FT_Get_Kerning;
    tableImport[9] = FT_Get_Char_Index;
    tableImport[10] = FT_Get_Glyph;
    tableImport[11] = FT_Init_FreeType;
    tableImport[12] = FT_New_Face;
    tableImport[13] = FT_Done_Face;
    tableImport[14] = FT_Done_Glyph;
    tableImport[15] = FT_Done_FreeType;
    tableImport[16] = FT_Set_Pixel_Sizes;
    tableImport[17] = FT_Load_Char;
    tableImport[18] = fclose;
    tableImport[19] = fopen;
    tableImport[20] = malloc;
    tableImport[21] = free;
    tableImport[22] = puts;
    tableImport[23] = pow;
}
...
int run_elf_module(struct elf_module *m, const char *func, int argc, char** argv)
{
    ...
    return fn(argc, argv, tableImport);
}
